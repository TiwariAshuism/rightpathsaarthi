	...
	return (
		<div ref={ref} className="lg:col-span-5 flex flex-col gap-10">
			...
			<div className="flex flex-col gap-6">
				<h3
					className={`text-[#111418] dark:text-white text-3xl font-black mb-2 transition-all duration-1000 ${
						isVisible
				...
				{contactInfo.items.map((item, index) => (
					<div
						key={index}
						className={`flex items-center gap-6 bg-white dark:bg-slate-900 p-6 rounded-3xl shadow-xl border border-gray-100 dark:border-slate-800 hover:border-primary/50 transition-all duration-700 group ${
							isVisible
								? "opacity-100 translate-x-0"
								: "opacity-0 -translate-x-10"
						}`}
			...
			{/* Map */}
			<div
				className={`w-full h-80 rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 dark:border-slate-800 relative bg-gray-200 transition-all duration-1000 delay-500 ${
					isVisible
