...
export const WhyChooseUs = (): FunctionComponent => {
	...
	return (
		<section
			ref={ref}
			className="w-full px-4 md:px-10 lg:px-40 py-20 bg-white dark:bg-[#101922] relative overflow-hidden"
		>
			...
			<div className="max-w-[1280px] w-full mx-auto relative z-10">
				<div
					className={`flex flex-col gap-4 text-center items-center mb-16 transition-all duration-1000 ${
				...
				>
					...
					<p
						className="text-slate-600 dark:text-slate-400 text-lg max-w-[700px]"
				...
				<div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[600px]">
					...
					<div
						ref={cardRef1 as any}
						className={`md:col-span-7 relative group rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 transition-all duration-1000 bg-white dark:bg-slate-900 shadow-xl ${
							isVisible
					...
					>
						<div
							...
							style={{
								backgroundImage:
									'url("https://lh3.googleusercontent.com/aida-public/AB6AXuC_B9risfZ_HEGAf8PG8QvxiZUmcvq4SgyR7uhttMJNDB8xWtCPNp-JeGT5KMsuI4Ig0UJj4ogqaizxBebLcqODiDZX7BmexpjF6OzrR2JIOmSyXX4nHIgPKUkMPDPbqolUcWEAi8PVDR5RrjgQOiG3edsCjuwyHx_06X5LKdlm2W3UEHDs7fcdoqp00uXky2a6lO3ccwQfewF0jnAuSzK-uQBSRCTZD3dTW4JcXhLk2SQsdCv7AnBaOJtI1UgXZ_RNxkwePbbMksU")',
							}}
						></div>
					...
					<div
						ref={cardRef2 as any}
						className={`md:col-span-5 relative group rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 transition-all duration-1000 bg-slate-50 dark:bg-slate-900/50 shadow-lg ${
							isVisible
								? "opacity-100 translate-y-0"
								: "opacity-0 translate-y-20"
						}`}
					...
					<div
						ref={cardRef3 as any}
						className={`md:col-span-5 relative group rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 transition-all duration-1000 bg-primary/[0.03] dark:bg-primary/[0.05] shadow-lg ${
							isVisible
								? "opacity-100 translate-y-0"
								: "opacity-0 translate-y-20"
						}`}
